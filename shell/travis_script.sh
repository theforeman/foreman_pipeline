...
docker exec cos su - user -c "((cd /projects/foreman && bundle exec rake db:create && bundle exec rake db:migrate && bundle exec rake db:seed && bundle exec rake test:foreman_pipeline) || exit 1)"
